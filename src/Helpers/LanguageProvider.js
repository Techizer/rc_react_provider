...
class LanguageProvider {
  ...
  Babysitter = ['Baby Care', 'جليسه اطفال    ']
  ...
  SearchBabysitter = ['Search Baby Care near your address', 'Search Baby Care near your address']
  Availablephysotharpst = ["Available Physiotherapist's", ' أخصائي علاج طبيعي متاح ']
  Availablebabysitter = ["Available Baby Care's", ' جليسة أطفال متاح ']
...
export const LanguageConfiguration = new LanguageProvider();
