            ...
            <View style={{
              ...
              <TouchableOpacity onPress={() => {
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', width: '95%', alignSelf: 'center' }}>
                  ...
                  >{this.state.select.length <= 0 ? LanguageConfiguration.select_issues_text[config.language] : this.state.select}</Text>
            ...
            <View style={{
              ...
              <View style={{ width: '95%', alignSelf: 'center', }}>
                <TextInput
                  ...
                  placeholder={this.state.selectissuefocus != true ? LanguageConfiguration.text_input_topic[config.language] : null}
